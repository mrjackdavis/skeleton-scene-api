...
var sequelize = new Sequelize('mysql://root:password@dockervm:49153/test_db',options={logging: false});

var Toast = sequelize.import('./ToastModel');
...
SceneStore.prototype.GetScene = function(params) {
	...
	return Toast.findById(sceneID).then(function(toast){
		return normaliseScene(toast);
	});
};

SceneStore.prototype.GetScenes = function() {
	return Toast.findAll().then(function(toasts){
